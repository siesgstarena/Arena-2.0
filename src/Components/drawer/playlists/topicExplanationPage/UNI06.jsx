...
const UNI06 = () => {
  const gettingStartedContent = (
    <div>
      ...
      <Body1 className="ml1">We are going to choose the sixth problem Time Never Stops</Body1>
    </div>
  );
  ...
  const dissectingProblemContent = (
    <div>
      ...
      <Body1 className="ml1">There is a very straightforward description for this problem.</Body1>
      <Body1 className="ml1">Understand the input output and the pattern for it.</Body1>
      <Body1 className="ml1">
        We have to extract the values for the hours and minutes first before processing them.
      </Body1>
    </div>
  );
  ...
  const pseudoCodeContent = (
    <div>
      ...
      <Body1 className="ma0">This is a simple set of steps written for our understanding.</Body1>
      <Body1>
      ...
      <Body1 className="ma0">
        We take input for time as hr:min and store the respective values in respective variables.
      </Body1>
      <Body1>
        This is easily achievable using scanf or cin creating a temporary variable, or using
        getchar(), or even using string delimiter!
      </Body1>
      <Body1>
        There are various ways to go ahead with this. We will keep things simple and use scanf here.
      </Body1>
      <Body1>
        We&apos;ll convert the hours to minutes, and minutes to seconds such that we have the amount
        of time in seconds starting from 00:00 that is 12 a.m.
      </Body1>
      ...
      <code>
        <div className="ba br4 bw2 b--gray bg-gray w-90-l">
          <div className="pa3 br4" style={{ backgroundColor: 'aliceblue' }}>
            ...
            <div className="mb4">
              using namespace <span className="green"> std</span>;
            </div>
            ...
            <div className="ml3">
              ...
              <div className="ml4">
                ...
                <div>
                  ...
                  <span className="red">&quot;%d:%d&quot;</span>, &hrs1, &min1);
                </div>
                <div className="mb3">
                  <span className="green">scanf</span>(
                  <span className="red">&quot;%d:%d&quot;</span>, &hrs2, &min2);
                </div>
                <div className="mb3">int second;</div>
                <div className="gray">
                  &#47;&#47; Converting time to seconds and calculating difference in one step
                </div>
                <div>
                  second = (((hrs2 - hrs1) * <span className="red">60</span>) + (min2 - min1)) *{' '}
                ...
                <div className="mt3 mb3">
                  ...
                  <span className="gray">
                    &#47;&#47; printing the value on new line \n is important
                  </span>
                </div>
              </div>
