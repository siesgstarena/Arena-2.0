...
const EditContest = ({ contestData, users }) => {
  ...
  const updateDB = async () => {
    ...
    // console.log(formDetails.code,formDetails.type, formDetails.name,
    // formDetails.description,String(
    // formDetails.start),String(formDetails.end),selectedAdmins,
    // formDetails.solutionVisibility);
