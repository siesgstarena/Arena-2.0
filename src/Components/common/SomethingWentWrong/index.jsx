...
const SomethingWentWrong = ({ message = 'An error has been encountered' }) => (
  <div className="mw6 center">
    ...
    <img
      ...
      src="https://res.cloudinary.com/ashokc/image/upload/f_auto,q_auto/v1589006297/arena/assets/undraw_bug_fixing_oc7a_zx8vqf.svg"
    />
    <Headline6 className="tc red mt2 mb3">{message}</Headline6>
  </div>
);
