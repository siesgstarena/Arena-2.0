...
const MessageCardGrid = () => {
  ...
  const MessagesArray = messages.map((member) => (
    <MessageCard message={member.message} name={member.name} color={member.color} key={member.id} />
  ));
    ...
    <Grid className="mt5 mb3 center mw8">
      ...
      <Row>
        <Cell className="" desktopColumns={4} phoneColumns={4} tabletColumns={4}>
          <Cell>{MessagesArray[0]}</Cell>
          <Cell>{MessagesArray[1]}</Cell>
        </Cell>
        <Cell desktopColumns={4} phoneColumns={4} tabletColumns={4}>
          <Cell>{MessagesArray[2]}</Cell>
          <Cell>{MessagesArray[3]}</Cell>
        </Cell>
        <Cell desktopColumns={4} phoneColumns={4} tabletColumns={4}>
          <Cell>{MessagesArray[4]}</Cell>
          <Cell>{MessagesArray[5]}</Cell>
        </Cell>
      </Row>
    </Grid>
  );
