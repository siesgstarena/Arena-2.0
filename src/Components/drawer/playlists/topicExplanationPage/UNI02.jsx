...
const UNI02 = () => {
  const gettingStartedContent = (
    <div>
      ...
      <Body1 className="ml1">We are going to choose the second problem Odd or Even.</Body1>
    </div>
  );
  ...
  const dissectingProblemContent = (
    <div>
      ...
      <Body1 className="mb1">There is a very straightforward description for this problem. </Body1>
      <Body1 className="ma0 mb1">Understand the input output and the pattern for it. </Body1>
  ...
  const pseudoCodeContent = (
    <div>
      ...
      <Body1 className="ma0">
        We need to take input for the integer. Then we&apos;ll check whether the integer is a
        multiple of 2 or not. This can be done easily by checking the remainder for the division of
        that number. If it is 0, means the number is ever or else it is odd. We&apos;ll print the
        parity in terms of &apos;E&apos; or &apos;O&apos; as per the description.
      </Body1>
    </div>
  );
          ...
          <div className="pa3 br4" style={{ backgroundColor: 'aliceblue' }}>
            ...
            <div className="ml3">
              ...
              <div className="ml3">
                ...
                <div className="ml4">
                  <span className="green">printf</span>(<span className="red">&quot;E&quot;</span>
                  );
                </div>
                <div className="ml3"> &#125; else &#123;</div>
                <div className="ml4">
                  <span className="green">printf</span>(<span className="red">&quot;O&quot;</span>
                  );
                </div>
