...
const HomePageCard = ({
  topThree, titleImage, props, title, subHead, cardLink,
}) => (
  <Card
  ...
  >
    <div className="cardHead center items-center mb2 pa3 pt3">
      <img alt="icon" className="b--transparent ba br-100 shadow-1" src={titleImage} height="75vh" />
      <div className="ml2">
      ...
      {topThree.map(
        (dev, index) => (
          <div className="mb3 mt3 flex items-center justify-between" key={dev.id}>
            ...
            <Body2 className="ma0 ml2 pointer black">
              (
              {dev[props]}
              )
            </Body2>
