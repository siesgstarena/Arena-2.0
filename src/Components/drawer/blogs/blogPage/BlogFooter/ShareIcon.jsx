...
const ShareIcon = () => {
  ...
  return (
    <div className="flex mt2">
      ...
      <a target="_blank" rel="noopener noreferrer" className="mr3" href={`whatsapp://send?text=${url}`} data-action="share/whatsapp/share"><img alt="whatsapp" src="https://img.icons8.com/office/32/000000/whatsapp.png" /></a>
