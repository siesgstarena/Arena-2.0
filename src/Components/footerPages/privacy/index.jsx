...
const Privacy = () => {
  document.title = 'SIESGSTarena | Privacy Policy';
  return (
    <div className="ml6-l mr6-l ml2 mr2 ml4-m mr4-m">
      ...
      <Body1>
        ...
        Policy. This Privacy Policy applies to activities by SIESGSTarena and its affiliates and
        subsidiaries (collectively “SIESGSTarena,” “we” or “us”).
      </Body1>
      <Body1>
      ...
      <Body1>
        ...
        <br />
        <span className="mid-gray">
          We collect and store the information and content that you post to the SIESGSTarena
          Platform, including your questions, answers, photos, comments. Unless you have posted
          certain content anonymously, Your Content, date and time stamps, and all associated
          comments are publicly viewable on the SIESGSTarena Platform, along with your name. This
          also may be indexed by search engines and be republished elsewhere on the internet. As of
          December 2018, we will be publishing all the data generated on this platform, on a website
          called&nbsp;
          <a
          ...
          . Data generated will be released as Datasets on Kaggle, for research purposes. This
          action is taken to motivate and strengthen research activities.
        </span>
      </Body1>
      <Body1>
      ...
      <Body1>
        ...
        <br />
        <span className="mid-gray">
          The security of your information is important to us. SIESGSTarena has implemented
          safeguards to protect the information we collect. However, no website or Internet
          transmission is completely secure. We urge you to take steps to keep your personal data
          safe, such as choosing strong password and keeping it private, as well as logging out of
          your user account, and closing your web browser when finished using the SIESGSTarena
          Platform.
        </span>
      </Body1>
      <Body1>
      ...
      <Body1>
        ...
        <br />
        <span className="mid-gray">
          The SIESGSTarena Platform may contain links to third party sites or online services. We
          are not responsible for the practices of such third parties, whose information practices
          are subject to their own policies and procedures, not to this Privacy Policy.
        </span>
      </Body1>
      <Body1>
        Contact Us
